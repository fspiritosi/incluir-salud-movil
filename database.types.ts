...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      prestaciones: {
        Row: {
          ...
          estado: Database["public"]["Enums"]["prestacion_estado"] | null
          fecha: string
          id: string
          monto: number | null
          notas: string | null
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "prestaciones_paciente_id_fkey"
            columns: ["paciente_id"]
            isOneToOne: false
    ...
    Functions: {
      ...
      cerrar_prestacion_con_validacion: {
        Args: {
          notas_cierre?: string
    ...
    Enums: {
      prestacion_estado: "pendiente" | "completada" | "cancelada" | "en_proceso"
      tipo_prestacion:
        | "consulta"
        | "cirugia"
        | "diagnostico"
